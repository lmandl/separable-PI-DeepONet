...
def loss_res(model_fn, params, batch):
    ...
    # Compute the flux term and conservative form residual
    flux_x = jax.jvp(lambda x: 0.5 * apply_net(model_fn, params, u, t, x) ** 2, (x,), (v_x,))[1]

    pred = s_t + flux_x - 0.01 * s_xx
...
if __name__ == "__main__":
    ...
    # result directory
    parser.add_argument('--result_dir', type=str, default='results/burgers/separable_conservative',
