...
def main_routine(args):
    ...
    # For the first \delta u, the branch network will take [H_0]
    # For the t-th \delta u, the branch network will take [H_(t-1)]
...
if __name__ == "__main__":
    ...
    # result directory
    parser.add_argument('--result_dir', type=str, default='results/fracture/separable_single/',
